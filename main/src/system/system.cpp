...
bool CSystem::initialize()
{
    ...
    GetBmp180Ctrl()->initialize(m_i2c_master);
    ...
    if (sensor && sensor->matter_init_endpoint()) {
        ...
        sensor->set_pressure_measurement_min_measured_value(300.f); // 300hPa
        sensor->set_pressure_measurement_max_measured_value(1100.f); // 1100hPa
    } else {
        return false;
    }
